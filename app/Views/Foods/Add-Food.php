...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title mt-5">Add Foods Category</h3>
            </div>
        </div>
    ...
    <form method="post" action="<?= base_url('food/store') ?>" enctype="multipart/form-data">
    <?= csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="row formtype">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Name Food Category</label>
                            <input class="form-control" id="name" name="name" type="text" value="<?= old('name'); ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="float-left">
                            <a class="btn btn-primary buttonedit mt-4 ml-10" href="<?= base_url('/food') ?>">Back To Foods Category</a>
                        </div>
                        <div class="">
