...
<div class="content container-fluid">
    ...
    <form method="post" action="<?= base_url('food/update/'. $roomfoods->id) ?>" enctype="multipart/form-data">
    <?= csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="row formtype">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" name="name" type="text" value="<?php echo $roomfoods->name; ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="float-left">
                            <a class="btn btn-primary buttonedit mt-4 ml-10" href="<?= base_url('food') ?>">Kembali Ke daftar Ruangan</a>
                        </div>
                        <div class="">
