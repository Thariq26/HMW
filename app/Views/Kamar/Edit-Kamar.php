...
<div class="content container-fluid">
    ...
    <form method="post" action="<?= base_url('roompricings/update/'). $pricings->id ?>" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="row formtype">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" name="name" type="text" value="<?= old('name', $pricings->name); ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Area</label>
                            <input class="form-control" id="area" name="area" type="text" value="<?= old('area', $pricings->area); ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Price</label>
                            <input class="form-control" id="price" name="price" type="text" value="<?= old('price', $pricings->price); ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="capacity" name="capacity">
                                <?php for ($i = 1; $i <= 10; $i++) : ?>
                                    <option value="<?= $i ?>" <?= old('bedcount',$pricings->capacity) == $i ? 'selected' : '' ?>><?= $i ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="roomcategory_id" name="roomcategory_id" required>
                                ...
                                <?php foreach ($roomcategories as $pricing): ?>
                                    <option value="<?= esc($pricing->id); ?>" <?= (old('roomname_id', $pricings->roomcategory_id) == $pricing->id) ? 'selected' : ''; ?>>
                                        <?= esc($pricing->name); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php foreach ($roomfoods as $food): ?>
                                    <option value="<?= esc($food->id); ?>" <?= (old('roomfood_id', $pricings->roomfood_id) == $food->id) ? 'selected' : ''; ?>>
                                        <?= esc($food->name); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php foreach ($roomcancelationcharges as $cancelcategory): ?>
                                    <option value="<?= esc($cancelcategory->id); ?>" <?= (old('roomcancelationcharges_id', $pricings->roomcancelationcharges_id) == $cancelcategory->id) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="smoking" name="smoking" required>
                                <option value="" disabled >Select</option>
                                <option value="Smoking" <?= (old('smoking', $pricings->smoking) == 'Smoking') ? 'selected' : ''; ?>>Smoking</option>
                                <option value="No Smoking" <?= (old('smoking', $pricings->smoking) == 'No Smoking') ? 'selected' : ''; ?>>No Smoking</option>
                            </select>
                        </div>
                    </div>
